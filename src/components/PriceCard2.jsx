...
export default function PriceCard2({ serial, p1 }) {
  return (
    <div className="mt-7.5 w-full border border-[#7070703a] md:flex">
      <div className="border-b border-[#DADADA] bg-[#FFD2D2]/25 py-[17px] text-center text-lg leading-[26px] tracking-[0.0147em] md:w-5/12 md:border-b-0 md:pl-5 md:text-left md:text-xl lg:w-6/12 lg:pl-6 lg:text-2xl xl:w-7/12 xl:pl-7.5 xl:text-[26px]">
        {serial}
      </div>
