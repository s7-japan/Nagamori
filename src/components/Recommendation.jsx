...
const Recommendation = () => {
  return (
    <div className="px-4 md:px-[13vw] mt-10">
      <h1 className="text-center text-[8vw] md:text-[4vw] mb-1">
        Recommendations
      </h1>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-[70%] md:pl-16 pt-0 md:pt-6 px-1 md:px-0">
          <p className="text-[4vw] md:text-[1.2vw] text-[#70707079]">Doctor</p>
          <h1 className="text-[9vw] md:text-[3vw]">⑤大西 真代</h1>
          <p className="italic text-[5vw] md:text-[1.5vw] mb-5">
            GRACY TOKYO CLINIC 院長
          </p>
          <p className="text-[5vw] md:text-[1.3vw] font-light">
      ...
      <div className="flex flex-col md:flex-row mb-10 mt-30">
        <div className="w-full md:w-[30%] flex items-center justify-center mb-6 md:mb-0">
          <img src={d2} alt="" className="h-[105vw] md:h-[80%]" />
        </div>
        <div className="w-full md:w-[70%] md:pl-16 pt-0 md:pt-6 px-1 md:px-0">
          <p className="text-[4vw] md:text-[1.2vw] text-[#70707079]">Doctor</p>
          <h1 className="text-[9vw] md:text-[3vw]">④池田 欣生</h1>
          <p className="italic text-[5vw] md:text-[1.5vw] mb-5">
      ...
      <div className="flex flex-col md:flex-row mb-10 mt-30">
        ...
        <div className="w-full md:w-[70%] md:pl-16 pt-0 md:pt-6 px-1 md:px-0">
          <p className="text-[4vw] md:text-[1.2vw] text-[#70707079]">Doctor</p>
          <h1 className="text-[9vw] md:text-[3vw]">③田中優太</h1>
          <p className="italic text-[5vw] md:text-[1.5vw] mb-5">
      ...
      <div className="flex flex-col md:flex-row mb-10 mt-30">
        ...
        <div className="w-full md:w-[70%] md:pl-16 pt-0 md:pt-6 px-1 md:px-0">
          <p className="text-[4vw] md:text-[1.2vw] text-[#70707079]">Doctor</p>
          <h1 className="text-[9vw] md:text-[3vw]">①前田 拓摩</h1>
          <p className="italic text-[5vw] md:text-[1.5vw] mb-5">
      ...
      <div className="flex flex-col md:flex-row mb-10 mt-30">
        ...
        <div className="w-full md:w-[70%] md:pl-16 pt-0 md:pt-6 px-1 md:px-0">
          <p className="text-[4vw] md:text-[1.2vw] text-[#70707079]">Doctor</p>
          <h1 className="text-[9vw] md:text-[3vw]">②細井 龍</h1>
          <p className="italic text-[5vw] md:text-[1.5vw] mb-5">
            アマソラクリニック院長
          </p>
          <p className="text-[5vw] md:text-[1.3vw] font-light">
