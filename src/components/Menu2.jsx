    ...
    <div className="px-12 md:px-[13vw] flex flex-col items-center mt-12 md:mt-20 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-24 md:gap-8">
        <div>
          ...
          <img src={tail} alt="" className="md:w-[80%]"/>
          <p className="text-[4vw] md:text-[1vw]">テールアイライン</p>
          <p className="text-[4vw] md:text-[0.8vw] leading-8 md:leading-6 font-light mt-5">
            「きれいなテールライン」をつくります。
        ...
        <div>
          ...
          <img src={lips} alt="" className="h-[40px]"/>
          <p className="text-[4vw] md:text-[1vw]">リップ</p>
          <p className="text-[4vw] md:text-[0.8vw] leading-8 font-light mt-5 md:leading-6">
        ...
        <div>
          ...
          <img src={hairline} alt="" className="h-[40px]"/>
